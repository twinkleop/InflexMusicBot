    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("InflexUpdates")
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("InflexUpdates")
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("InflexUpdates")
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("InflexUpdates")
